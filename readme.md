...
- [DirectEnpack](https://github.com/fersatgit/DirectEnpack#readme) :octocat: - cpg-аддон для компоновки прямоугольных объектов на лист. Nesting-укладчик, написанный на ассемблере.
